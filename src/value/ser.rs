...
///
/// This is the serializer that backs [`serde_hjson::to_value`][crate::to_value].
/// Unlike the main serde_hjson serializer which goes from some serializable
...
/// ```
/// use serde::Serialize;
/// use serde_hjson::{Error, Value};
///
/// pub fn to_value<T>(input: T) -> Result<Value, Error>
/// where
///     T: Serialize,
/// {
///     input.serialize(serde_hjson::value::Serializer)
/// }
/// ```
