...
//! # No-std support
//!
//! As long as there is a memory allocator, it is possible to use serde_hjson
...
#![doc(html_root_url = "https://docs.rs/serde_hjson/1.0.0-alpha1")]
