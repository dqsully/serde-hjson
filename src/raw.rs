...
/// ```toml
/// [dependencies]
/// serde_hjson = { version = "1.0", features = ["raw_value"] }
/// ```
///
/// # Example
///
...
/// use serde_hjson::{Result, value::RawValue};
///
/// #[derive(Deserialize)]
/// struct Input<'a> {
///     code: u32,
...
/// //
/// // This could be done equivalently using serde_hjson::Value as the type for
...
///     let input: Input = serde_hjson::from_str(input)?;
///
///     let output = Output {
///         info: (input.code, input.payload),
///     };
///
///     serde_hjson::to_string(&output)
/// }
///
/// fn main() -> Result<()> {
...
/// # use serde_hjson::value::RawValue;
/// #
/// #[derive(Deserialize)]
/// struct SomeStruct<'a> {
///     #[serde(borrow)]
...
/// [`serde_hjson::from_str`] and [`serde_hjson::from_slice`] which support
/// borrowing from the input data without memory allocation.
///
/// When deserializing through [`serde_hjson::from_reader`] you will need to use
...
///
/// [`serde_hjson::from_str`]: ../fn.from_str.html
/// [`serde_hjson::from_slice`]: ../fn.from_slice.html
/// [`serde_hjson::from_reader`]: ../fn.from_reader.html
///
/// ```
/// # use serde::Deserialize;
/// # use serde_hjson::value::RawValue;
...
impl RawValue {
    ...
    ///
    /// This function is equivalent to `serde_hjson::from_str::<Box<RawValue>>`
    ...
    ///     let response: Response = serde_hjson::from_str(input)?;
    ///
...
/// // Local crate
/// use serde::Serialize;
/// use serde_hjson::value::{to_raw_value, RawValue};
///
/// #[derive(Serialize)]
/// struct MyExtraData {
///     a: u32,
...
/// };
/// # assert_eq!(
/// #     serde_hjson::to_value(my_thing).unwrap(),
/// #     serde_hjson::json!({
/// #         "foo": "FooVal",
/// #         "bar": null,
/// #         "extra_data": { "a": 1, "b": 2 }
...
///
/// println!("{}", serde_hjson::value::to_raw_value(&map).unwrap_err());
/// ```
...
pub const TOKEN: &str = "$serde_hjson::private::RawValue";
